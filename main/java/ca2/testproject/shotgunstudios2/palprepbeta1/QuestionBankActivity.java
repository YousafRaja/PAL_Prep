 ...
 */
public class QuestionBankActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_questionbank_appbar);
    ...
    public void onRadioButtonClicked(View view) {
        ...
        explanationField.setText(    htPrompt.get ( (currentQuestion)).explanation     );
